...
<center>
<div style="margin-top: 150px; background: rgba(0, 0, 0, 0.5);  padding: 50px; margin-left: 80px; margin-right: 80px;">
<div>
<h1 style="color: white;">Our New Online Grocerry Store</h1>
</div>
<br>
<div><h3 style="color: white;">This is my first website so please contribute with us and shop more and more</h3></div>
<div>
<br>
<a href="Login.jsp"><button class="btn btn-outline-success" style="color: white; border-width: 3px;" type="submit">Login</button></a>

<a href="SignUp.jsp"><button class="btn btn-outline-success" type="submit" style="color: white; border-width: 3px;">Sign Up</button></a>
</div>
</div>
</center>
